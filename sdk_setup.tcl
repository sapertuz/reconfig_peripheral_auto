...
app create -name $app_name -template "Empty Application(C)" -platform "hw" -proc ps7_cortexa9_0 -os standalone
...
app create -name fsbl -template "Zynq FSBL" -proc ps7_cortexa9_0 -platform "hw" -os standalone
